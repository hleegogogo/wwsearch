...
static const std::string rocksdb_build_git_sha  = "rocksdb_build_git_sha:e7c2b2f7bcf3b4b33892a1a6d25c32a93edfbdb9";
static const std::string rocksdb_build_git_tag = "rocksdb_build_git_tag:master";
#define HAS_GIT_CHANGES 1
#if HAS_GIT_CHANGES == 0
// If HAS_GIT_CHANGES is 0, the GIT date is used.
// Use the time the branch/tag was last modified
static const std::string rocksdb_build_date = "rocksdb_build_date:2021-10-21 18:44:13";
#else
// If HAS_GIT_CHANGES is > 0, the branch/tag has modifications.
// Use the time the build was created.
static const std::string rocksdb_build_date = "rocksdb_build_date:2022-03-20 01:28:20";
#endif
